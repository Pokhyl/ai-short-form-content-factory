...
export function buildVisualSegments(timedBeats, options = {}) {
  ...
  for (let i = 0; i < segments.length; i += 1) {
    ...
    // A semantic segment is one visual obligation. Additional shots may only be introduced by a future deterministic semantic/representation transition, never by elapsed time alone.
    segment.planned_shot_count = 1;
