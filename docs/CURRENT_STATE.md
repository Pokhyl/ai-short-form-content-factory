...
Live verified M5 v94 (`b4122d0a-5754-4311-8b7a-adab15ff0697`) / M8 v45 (`3778d30c-70c0-4cd2-9df8-e8465d4fdd7a`). PL15 `cd432c5e-20b2-4f08-ad45-3cc21d4ee588` passes machine QA but fails exact-frame visual QA in S3/S4/S5. EN30 must wait. See CODEX_HANDOFF.md and acceptance/2026-09-21-pl15-v94-review.json for evidence and next action. Older milestone/status sections below are historical, not the deployment inventory.
