...
5. Never touch another project to make this one work. The only allowed shared-runtime exception is the two project-owned Gemini credential gateway workflows `ShortsV2GeminiTextGateway001` and `ShortsV2GeminiTtsGateway001`; do not modify unrelated shared workflows or credentials.
