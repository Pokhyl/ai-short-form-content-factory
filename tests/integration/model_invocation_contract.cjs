...
const fixture={claim_prompt:'Candidate fixture',story_prompt:'Story fixture',rewrite_prompt:'Rewrite fixture',unit_word_targets:[{unit_id:'U1',target_words:4},{unit_id:'U2',target_words:4},{unit_id:'U3',target_words:4}],input:[{type:'text',text:'Review fixture'}]};
let checked=0;
