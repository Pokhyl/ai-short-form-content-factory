...
assert.match(nodes.get('Select Verified Claim Inventory').parameters.jsCode,/claimAssets\.length===2/);
assert.match(nodes.get('Select Verified Claim Inventory').parameters.jsCode,/origin_claim_id/);
assert.match(nodes.get('Prepare Inventory Grounded Story').parameters.jsCode,/TWO distinct reviewer-approved real images reserved before narration/);
...
assert.match(final,/asset_ids:assetIds/);
