...
assert.match(nodes.get('Prepare Candidate Claims').parameters.jsCode,/Do NOT write the final narration yet/);assert.match(nodes.get('Prepare Candidate Claims').parameters.jsCode,/editorial_role must be one of/);assert.match(nodes.get('Prepare Candidate Claims').parameters.jsCode,/visual_form must be one of/);
