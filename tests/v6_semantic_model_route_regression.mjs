...
assert.match(code,/\(route==='semantic'\|\|route==='final_story'\)\?'liquid\/lfm-2\.5-2\.6b:free'/);
assert.match(code,/route==='semantic'\?4096/);
assert.match(code,/route==='semantic'\|\|route==='final_story'\)model_request_body\.include_reasoning=false/);
